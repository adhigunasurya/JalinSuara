	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (mSubProject != null) {
			...
			if (mSubProject.getDescription() != null) {
				...
				mInformationContent1.setText("Jumlah Proposal(L): "+mSubProject.getMaleProposal());
				mInformationContent2.setText("Jumlah Proposal(P): "+mSubProject.getMaleProposal());
				mInformationContent4.setText("Panjang Proyek: "+mSubProject.getProjectLength());
				mInformationContent5.setText("Panjang Proyek: "+mSubProject.getProjectArea());
				mInformationContent6.setText("Panjang Proyek: "+mSubProject.getProjectQuantity());
	
				mInformationContent21.setText("BLM: "+mSubProject.getBlmAmount());
				mInformationContent22.setText("Swadaya Masyarakat: "+mSubProject.getSelfFundAmount());
				
				mInformationContent23.setText("Penerima Manfaat (L): "+mSubProject.getMaleBeneficiary());
				
				mInformationContent24.setText("Penerima Manfaat (P): "+mSubProject.getFemaleBeneficiary());
				
				mInformationContent25.setText("Penerima Manfaat (Miskin): "+mSubProject.getPoorBeneficiary());
